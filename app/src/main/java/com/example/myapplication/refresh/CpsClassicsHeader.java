...
public class CpsClassicsHeader  extends ClassicsAbstract<CpsClassicsHeader> implements RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public CpsClassicsHeader(Context context) {
        this(context, null);
    }

    public CpsClassicsHeader(Context context, AttributeSet attrs) {
        super(context, attrs, 0);

        View.inflate(context, R.layout.cp_srl_classics_header, this);
        ...
        lpProgress.rightMargin = ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlDrawableMarginRight, SmartUtil.dp2px(8));
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTitle, SmartUtil.dp2px(13)));
//        } else {
//            mTitleText.setTextSize(16);
        }

        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTime)) {
            mLastUpdateText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTime, SmartUtil.dp2px(13)));
//        } else {
//            mLastUpdateText.setTextSize(12);
    ...
    public CpsClassicsHeader setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public CpsClassicsHeader setTimeFormat(DateFormat format) {
    ...
    public CpsClassicsHeader setLastUpdateText(CharSequence text) {
        mLastTime = null;
        mLastUpdateText.setText(text);
        return this;
    }

    public CpsClassicsHeader setAccentColor(@ColorInt int accentColor) {
        mLastUpdateText.setTextColor(accentColor&0x00ffffff|0xcc000000);
        return super.setAccentColor(accentColor);
    }

    public CpsClassicsHeader setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
    ...
    public CpsClassicsHeader setTextSizeTime(float size) {
    ...
    public CpsClassicsHeader setTextSizeTime(int unit, float size) {
    ...
    public CpsClassicsHeader setTextTimeMarginTop(float dp) {
        final View updateView = mLastUpdateText;
    ...
    public CpsClassicsHeader setTextTimeMarginTopPx(int px) {
