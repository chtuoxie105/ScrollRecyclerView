...
public class CpsClassicsFooter  extends ClassicsAbstract<CpsClassicsFooter> implements RefreshFooter {
    ...
    public CpsClassicsFooter(Context context) {
        this(context, null);
    }

    public CpsClassicsFooter(Context context, AttributeSet attrs) {
        super(context, attrs, 0);

        View.inflate(context, R.layout.cps_srl_classics_footer, this);
